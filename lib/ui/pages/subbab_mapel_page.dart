...
class SubbabMapelPage extends StatefulWidget {
  SubbabMapelPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _SubbabMapelPageState createState() => new _SubbabMapelPageState();
}

const htmlData = r"""
<p id='top'><a href='#bottom'>Scroll to bottom</a></p>
<video controls>
    <source src="https://vod-progressive.akamaized.net/exp=1628766106~acl=%2Fvimeo-prod-skyfire-std-us%2F01%2F3306%2F20%2F516532097%2F2399156935.mp4~hmac=78954f0d61ee883ca79ee3fe25cd46214e731073fbc85a0693e8d73f554d5374/vimeo-prod-skyfire-std-us/01/3306/20/516532097/2399156935.mp4?filename=Cat+-+66004.mp4" />
  </video>
  <iframe width="600" height="400" src="https://www.youtube.com/embed/oeIZyxGc5uA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <h1>Header 1</h1>
      <h2>Header 2</h2>
      <h3>Header 3</h3>
      <h4>Header 4</h4>
      ...
      <img src='asset:assets/icons/logo.png' width='100' />
      <h3>Local asset svg</h3>
      <img src='asset:assets/icons/google.svg' width='100' />
...
class _SubbabMapelPageState extends State<SubbabMapelPage> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: SingleChildScrollView(child: htmlWidget(htmlData)),
    );
  }
}
